...
namespace Nop.Web.Controllers
{
    public class NhaXeBaoCaoController : BaseNhaXeController
    {
        ...
        public ActionResult BaoCaoDoanhThu()
        {
            ...
            var hanhtrinhquangninhids = string.Join(",", _nhaxeService.GetHanhTrinhKhuVucsByKhuvucId((int)ENKhuVuc.QUANG_NINH).Select(c => c.HanhTrinhId).ToArray());
            ...
            modeldoanhthu.ListLoai2.Add(new SelectListItem
            {
                Value = hanhtrinhquangninhids,
                Text = "Các tuyến đi, về từ Quảng ninh"
            });
